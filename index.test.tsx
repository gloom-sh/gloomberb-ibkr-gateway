...
import { ibkrGatewayPlugin } from "./index";
...
function setupIbkrPlugin(config: AppConfig) {
  ...
  // A partial context: this test only exercises the registration calls the
  // plugin makes, so the rest of the surface is deliberately absent.
  } as unknown as GloomPluginContext;

  void ibkrGatewayPlugin.setup?.(ctx);
